...
%DXC% -HV 2021 -Zpr -O3 -WX -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T cs_6_6 -E MainCS -Fc TSRRejectShading.d3dasm -Fo TSRRejectShading.dxil TSRRejectShading.usf
:END
PAUSE
